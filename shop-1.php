...
<html>
   <head>
      ...
      <!------------------------------------owl--------------------------------------------------------------------->
      <link type="text/css" rel="stylesheet" href="owl/assets/owl.carousel.min.css">
      <link type="text/css" rel="stylesheet" href="owl/assets/owl.theme.default.min.css" />
      <!------------------------------------owl--------------------------------------------------------------------->
    <!--Favicon-->
         ...
         <div class="Products-checkout">
         	<div class="container">
            	<div class="row">
                	<div class="col-lg-12">
                    	<div class="customer">
                        	<h2>Exisitng Customer? <span> Click here to login  </span></h2>
                        </div>
                        <div class="customer">
                        	<h2> Have a Coupon? <span> Click here to enter your code </span></h2>
                        </div>
                    </div>
                </div>
          ...
          <div class="check_out_form ">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 submit_form">
                    ...
                    <div class="create">
                    	<h2><input type="checkbox">Create an Account</h2>
                    </div>
                </div>
                <!-- /submit_form -->
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 submit_form shipping_address">
                    <div class="section-title inner">
                        <h2>Shipping to a Different Address <input type="checkbox"></h2>
                    </div>
                    <form action="#" class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <span>Country *</span>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <textarea placeholder="Special notes about your order..."></textarea>
                        </div>
                    </form>
                </div>
                <!-- /submit_form -->
            ...
            <div class="row">
                        ...
                        <table class="table table-1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="pdleft0"><span>Quantity</span></th>
                                    <th><span class="margleft9">Total</span></th>
                                </tr>
                            </thead>
                            <!-- /thead -->
                            <tbody>
                                ...
                                <tr>
                                    <td class="flex_item clear_fix">
                                        <img src="image/shop-1/checkout-2.jpg" alt="images" class="float_left">
                                ...
                                <tr>
                                    <td class="flex_item clear_fix">
                                         <img src="image/shop-1/checkout-1.jpg" alt="images" class="float_left">
                                        <h6 class="float_left">Lords Of Strategy</h6>
                                    </td>
                                    <td>
                                        <input type="number" name="quantity" min="0" value="3">
                                    </td>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="payment_system">
                        ...
                        <a href="#" class="tran3s color2_bg">Place Order</a>
                    </div>
                </div>
            </div>
        </div>
                  ...
                  <div class="row">
                     <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 fist">
                        <div class="image logo">
                           <img src="image/footer-lo.png" class="img-responsive" alt="logo" width="161" height="42" />
                        </div>
                     ...
                     <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 sec">
                        ...
                        <div class="description link last">
                           <table>
                              <tbody>
                                 <tr>
                                    <td class="fist"><a>About Us</a></td>
                                    <td><a>Services</a></td>
                                 </tr>
                                 <tr>
                                    <td class="fist"><a>Meet Our Team</a></td>
                                    <td><a>FAQ’S</a></td>
                                 </tr>
                                 <tr>
                                    <td class="fist"><a>Case Studies</a></td>
                                    <td><a>News</a></td>
                                 </tr>
                                 <tr>
                                    <td class="fist"><a>Get a Quote</a></td>
                                    <td><a>Shop</a></td>
                                 </tr>
                                 <tr>
                                    <td class="fist"><a>Testimonials</a></td>
                                    <td><a>Industries</a></td>
                                 </tr>
                                 <tr>
                                    <td class="fist"><a>Contact Us</a></td>
                                    <td><a></a></td>
                                 </tr>
                              </tbody>
                           </table>
                     ...
                     <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="description ">
                           <p>Subscribing to our mailing list
