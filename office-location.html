...
<html>
   ...
   <div class="preloader" id="preloader"></div>
               ...
               <div class="container">
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="image">
                           <img src="image/office-locations/offiice-location-1.jpg" class="img-responsive" alt="office" width="370" height="353" />
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  ...
                  <div class="row space">
                     ...
                     <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="image">
                           <img src="image/office-locations/offiice-location-2.jpg" class="img-responsive" alt="office" width="370" height="353" />
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="content-outer-office">
                  ...
                  <div class="row space">
                     ...
                     <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="image">
                           <img src="image/office-locations/offiice-location-3.jpg" class="img-responsive" alt="office" width="370" height="353" />
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="content-outer-office">
                  ...
                  <div class="row space">
                     ...
                     <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="image">
                           <img src="image/office-locations/offiice-location-4.jpg" class="img-responsive" alt="office" width="370" height="353" />
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="content-outer-office">
      ...
      <script src="js/bootstrap.min.js"> </script>
        ...
        <script src="homepage6/js/gmaps.js"></script>
        <script src="homepage6/js/map-script.js"></script>
      <!-- script JS  -->
