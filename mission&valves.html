                  ...
                  <div class="row ">
                     <div class="col-lg-5 col-md-5 col-xs-12 col-sm-12 top-in">
                        <div class="top-left-inner">
                           <p class="icn">
                              <img src="image/svg1/ok-mark.svg" class="ok-mark" alt="logo"  >
                           </p>
                        ...
                        <div class="right-header">
                           <div class="header-info">
                              <div class="info-inner ">
                                 <span class="icontop ">
                                    <img src="image/svg1/phone-call.svg" class="icon-top-head" alt="logo" >
                                 </span>
                                 <span class="iconcont">1 (857) 899-0009<br><a>Any quries? Call us.</a></span>
                              </div>
                              <div class="info-inner ">
                                 <span class="icontop"><img src="image/svg1/placeholder.svg" alt="logo"  class="icon-top-head"></span>
                  ...
                  <div class="container">
                     <div class="row">
                        <div class="site-logo col-md-3 col-sm-6 col-xs-6">
                           <a href="#" class="logo">
                              <img src="image/svg1/logo-delware.png" class="logo-dark show-logo" alt="logo" />
                           </a>
                     ...
                     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="mission-outer">
                           <div class="mission-inner">
                              ...
                              <p>How to pursue pleasure rationally encounter consequences that are extremely painful. Nor again is there anyone who loves or pursues or desires to obtain pain of itself, because it is pain, but because occasionally circumstances.</p>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                     ...
                     <div class="col-lg-12">
                        <div class="bottom-section core-values">
                           <div class="heading">
                              ...
                              <p>“We are a values-driven organization. Our values reflect the thinking of our founder, William John.”</p>
                           </div>
