                ...
                <div class="row">
                    <div class="col-md-6 pa-5">
                        <div class="panel-heading">
                            <h3 class="panel-title">Values' Page Description</h3>
                        ...
                        <div class="panel-heading">
                            <div class=" navbar-btn-right">
                                <a class="btn btn-success update-pro" href="#add" data-toggle="modal" name="Set"
                                    title="Edit Values section" onclick="openAdd()"><i class="fa fa-edit"></i> <span>Edit
                                        Values Section</span></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal" id="add" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Edit Values Section</h3>
                        ...
                        <div class="panel-body">
                            <form method="post" enctype="multipart/form-data" action="Values.php">
                                ...
                                <textarea class="form-control" placeholder="textarea" rows="4" name="Values"><?php
                    echo $ValuesInfo[0];
                        ?></textarea><br>
