...
header( 'Content-Type: text/html; charset=utf-8' );
    ...
    $accept = $TipObj->viewTip();

    
    if (isset($_POST['Add'])) {  
        $title = $_POST["Title"];  
        $description = $_POST["Description"];
      $TipObj->addTip($title, $description);
        ...
        exit();
		   ...
		   $TipObj->updateTip($ID, $title, $description);
        ...
        <div class="row"> 
            ...
            <div class="col-md-6 pa-5">
                        ...
                        <a class="btn btn-success" href="#add" data-toggle="modal" name="Set"
                                 ...
                                 class="fa fa-plus"></i> <span>Add Tip</span></a>     
...
for ($i = 0; $i < sizeof($tipID); $i++) {
			echo '<div class="panel">';
				echo '<div class="panel-heading">';
					echo '<h3 class="panel-title">'.$title[$i];
                      echo '<a href="#modal2" data-toggle="modal" name="Set" data-id="'.$tipID[$i].'" data-title="'.$title[$i].'" data-description="'.$description[$i].'" class="modal-trigger"><i class="fa fa-edit" onclick="openModal2()" style="float:right;"></i></a>';
                echo '<a href="#modal3" data-toggle="modal" name="Set" data-id="'.$tipID[$i].'" class="modal-trigger"><i class="fa fa-remove"  style="float:right;" onclick="openModal3()"></i></a></h3>';
				echo '</div>';
...
<div class="modal" id="modal" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Add Tip</h3>

                    </div>

                    <div class="panel-body">
                        <form method="post" enctype="multipart/form-data" action="tips.php">
...
<div class="modal" id="modal2" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Update Tip</h3>
...
<div class="modal" id="modal3" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Remove Tip</h3>
