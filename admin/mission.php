...
$MissionInfo=$accept[2];

//Update Info
if (isset($_POST['Update'])) {
  
  $Mission = $_POST["Mission"];
  $infoObj->updateInfo("",$Mission,"");
}
?>
                ...
                <div class="row">
                    <div class="col-md-6 pa-5">
                        <div class="panel-heading">
                            <h3 class="panel-title">Mission Page Description</h3>
                        ...
                        <div class="panel-heading">
                            <div class=" navbar-btn-right">
                                <a class="btn btn-success update-pro" href="#add" data-toggle="modal" name="Set"
                                    title="Edit Mission section" onclick="openAdd()"><i class="fa fa-edit"></i> <span>Edit
                                        Mission Section</span></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal" id="add" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Edit Mission Section</h3>

                        </div>

                        <div class="panel-body">
                            <form method="post" enctype="multipart/form-data" action="Mission.php">
