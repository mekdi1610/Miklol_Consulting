...
<html>
   <head>
      ...
      <link type="text/css" rel="stylesheet" href="css/iconsicons.css"/>
      ...
      <div id="page" class="page-wrapper header-sticky header-v1 hide-topbar-mobile header-sticky">
         <div class="wapper">
            ...
            <div class="top">
               <div  class="container">
                  <div class="row ">
                     <div class="top-in col-lg-5 col-md-5 col-xs-12 col-sm-12">
                     ...
                     <div class="top-in  col-inner col-lg-7 col-md-7 col-xs-12 col-sm-12">
               ...
               <div class="container">
                  <div class="row">
                     <div class="col-lg-2 col-md-2 col-xs-12 col-sm-12">
                        <div class="logo">
                            <a href="index.html"><image src="image/logo-delware.png" class="image-responsive" alt="logo" width="161" height="42" /></a>
                        </div>
                     </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div id="search-3" class="widget widget_search">
                           <form class="search-form" action="http://steelthemes.com/demo/html/factoryplus_html/blog-classic.html#">
                              <label>
                              <input type="search" class="search-field form-control" placeholder="Your Keyword" value="" name="s">
                              </label>
                     ...
                     <!------------------------------side-bar-end----------------------------->  
                     <!------------------------------page-content-start----------------------------->
                     <div class="faqs col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <div class="panel-group" id="accordion">
                           <div class="panel panel-default">
                              <div class="panel-heading">
                                 <h4 class="panel-title">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                                    How to purchase Delaware theme?
                           ...
                           <div class="panel panel-default">
                              <div class="panel-heading">
                                 <h4 class="panel-title">
                                    ...
                                    What are the main features of Delaware?
